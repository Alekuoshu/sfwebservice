...
class CustomerFormatterCore implements FormFormatterInterface
{
    ...
    public function getFormat()
    {
        ...
        // Get some values
        // Privacy policy
        $privacy_1 = Configuration::get('SFWEBSERVICE_PRIVACY_POLICY');
        $privacy_1 = str_replace('<p>', '', $privacy_1);
        $privacy_1 = str_replace('</p>', '', $privacy_1);
        // Another privacy policy
        $privacy_2 = Configuration::get('SFWEBSERVICE_PRIVACY_POLICY_2');
        $privacy_2 = str_replace('<p>', '', $privacy_2);
        $privacy_2 = str_replace('</p>', '', $privacy_2);
        // Terms and conditions
        $privacy_3 = Configuration::get('SFWEBSERVICE_TERMS_CONDITIONS');
        $privacy_3 = str_replace('<p>', '', $privacy_3);
        $privacy_3 = str_replace('</p>', '', $privacy_3);


        // new code
        if($privacy_1){
            $format['politica'] = (new FormField)
                ->setName('politica')
                ->setType('checkbox')
                ->setLabel(
                    $privacy_1
        ...
        // new code
        if($privacy_2){
            $format['politicafm'] = (new FormField)
                ->setName('politicafm')
                ->setType('checkbox')
                ->setLabel(
                    $privacy_2
